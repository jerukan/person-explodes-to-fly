...
namespace ExplosionJumping.PlayerControl {
    ...
    public class FirstPersonControllerCustom : MonoBehaviour {
        ...
        public float autoClimbMaxHeight = 0.3f;
        ...
        private float timeOnGround; // time the player has spend on the ground in the duration of being grounded.
        private float totalTimeInAir; // total time player has spend in the air (persistent between jumps).
        private float timeWhenJumpedInAir; // when the player pressed the jump button while still in the air.
        ...
        public bool ShouldJump {
            set {
                ...
                if (!autoBunnyHop && !Grounded && shouldJump) {
                    timeWhenJumpedInAir = totalTimeInAir;
                }
            }
        }
        ...
        private void Update() {
            //Utils.LogValue("Autoclimbing...", AutoClimbing);
            //Utils.LogValue("Grounded?", Grounded);
        }
        ...
        private void FixedUpdate() {
            ...
            if (Grounded) {
                ...
                shouldJump |= totalTimeInAir - timeWhenJumpedInAir <= bunnyHopWindow / 2f;
                ...
                else if (timeOnGround > bunnyHopWindow / 2f) { // when completely grounded, ignore gravity and stick to ground
        ...
        private void PerformAutoClimb(Collision collision) {
            ...
            // if the bottom of the elevation is part of a walkable slope, do nothing
